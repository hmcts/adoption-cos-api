...
class CaseworkerCheckAndSendOrdersTest {
    ...
    void caseworkerCheckAndSendOrdersAboutToStart() {
        ...
        manageOrderList = archiveManageOrdersHelper(manageOrderList, orderData1);
        archiveManageOrdersHelper(manageOrderList, orderData2);
        archiveManageOrdersHelper(manageOrderList, orderData3);
    ...
    void caseworkerAboutToSubmit_OK() {
        ...
        manageOrderList = archiveManageOrdersHelper(manageOrderList, manageOrderData1);
        commonOrderList = archiveManageOrdersHelper(commonOrderList, orderData1);
