...
public final class TestConstants {
    ...
    public static final String TEST_USER_EMAIL = "test@hmcts.net";
    public static final String TEST_USER_EMAIL_2 = "test2@hmcts.net";
    public static final String TEST_USER_EMAIL_3 = "test3@hmcts.net";
    public static final String TEST_USER_EMAIL_4 = "test4@hmcts.net";
