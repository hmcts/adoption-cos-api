...
Scenario('Verify details of manage hearing tab when a new hearing is added', async ({
                                                                                      I,
                                                                                      caseViewPage,
                                                                                      manageHearingsPage,
...
Scenario('Hearings Tab - Vacate Hearing with Agreement and Relisting', async ({
                                                                                I,
                                                                                loginPage,
                                                                                caseListPage,
                                                                                caseViewPage,
...
Scenario('Hearings Tab - Adjourn Hearing with Relisting', async ({
                                                                   I,
                                                                   loginPage,
                                                                   caseListPage,
                                                                   caseViewPage,
