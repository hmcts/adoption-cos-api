module.exports = {
  finalOrderDetails: {
    ...
    adoptionFirstNameError: 'First name after adoption is required',
    adoptionLastNameError: 'Last name after adoption is required',
    FAODateAndPlaceOFBirth: 'Final adoption order date and place of birth',
