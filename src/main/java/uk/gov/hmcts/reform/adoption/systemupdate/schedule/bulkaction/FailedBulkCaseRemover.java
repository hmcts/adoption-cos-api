...
import static uk.gov.hmcts.reform.adoption.bulkaction.ccd.event.SystemEmptyCase.SYSTEM_EMPTY_CASE;
import static uk.gov.hmcts.reform.adoption.bulkaction.ccd.event.SystemRemoveFailedCases.SYSTEM_REMOVE_FAILED_CASES;
