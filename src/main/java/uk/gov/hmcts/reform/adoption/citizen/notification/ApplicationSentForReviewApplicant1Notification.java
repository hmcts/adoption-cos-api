...
import static uk.gov.hmcts.reform.adoption.notification.EmailTemplateName.JOINT_APPLICANT1_ANSWERS_SENT_FOR_REVIEW;
...
public class ApplicationSentForReviewApplicant1Notification {
    ...
    public void send(CaseData caseData, Long id) {
        ...
        Map<String, String> templateVars =
            commonContent.mainTemplateVars(caseData, id, caseData.getApplicant1(), caseData.getApplicant1());
