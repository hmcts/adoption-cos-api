package uk.gov.hmcts.reform.adoption.bulkaction.ccd.tab;
...
public class BulkActionCaseTypeTab implements CCDConfig<BulkActionCaseData, BulkActionState, UserRole> {
    ...
    public void configure(final ConfigBuilder<BulkActionCaseData, BulkActionState, UserRole> configBuilder) {
        ...
        configBuilder.tab("documentList", "Document List")
            .field(BulkActionCaseData::getPronouncementListDocument);
