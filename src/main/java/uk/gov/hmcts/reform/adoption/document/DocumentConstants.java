...
public final class DocumentConstants {
    ...
    public static final String MANAGE_HEARING_NOTICES_A94_FILE_NAME_OTHER_PERSON =
        "Other_person_with_parental_responsibilities_hearing_notice";
    ...
    public static final String APPLICATION_DOCUMENT_URL = "link_to_application_doc";
    public static final String HYPHENATED_REF = "hyphenatedCaseRef";
