    ...
    private static final Map<String, TriConsumer<Map<String, Object>, String, Object>> migrations = Map.of(
        ...
        "d11Document", (data, key, val) -> data.put("answerReceivedSupportingDocuments",
                                                    List.of(ListValue
                                                                ...
                                                                .id("1")
                                                                .value((AdoptionDocument) val)
                                                                .build()
                                                    )
        ),
        "generalApplicationFeeAccountNumber",
         (data, key, val) -> data.put("generalApplicationFeePbaNumbers",
                                     DynamicList
                                         .builder()
        ...
        "bulkListCaseReference",
        (data, key, val) -> data.put("bulkListCaseReferenceLink",
                                       CaseLink
                                           .builder()
