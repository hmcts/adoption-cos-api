...
public class SystemAccess implements HasAccessControl {
    @Override
    public SetMultimap<HasRole, Permission> getGrants() {
        ...
        grants.putAll(SYSTEM_USER, Permissions.CREATE_READ_UPDATE_DELETE);//TODO remove delete access for SYSTEM_USER
