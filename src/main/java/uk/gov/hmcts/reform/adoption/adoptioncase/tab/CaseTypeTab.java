...
public class CaseTypeTab implements CCDConfig<CaseData, State, UserRole> {
    ...
    public void buildChildDetailsTab(ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        configBuilder.tab("otherParties", "Other Parties")
            ...
            .label("labelSummary-additionalAdoptionAgencySub", null, "### Additional Adoption Agency")
            .field("additionalAdopAgencyOrLaName")
            .field("additionalAdopAgencyOrLaContactName")
            .field("additionalAdopAgencyAddressLine1")
            .field("additionalAdopAgencyTown")
            .field("additionalAdopAgencyPostcode")
            .field("additionalAdopAgencyOrLaPhoneNumber")
            .field("additionalAdopAgencyOrLaContactEmail")
