...
public class CaseTypeTab implements CCDConfig<CaseData, State, UserRole> {
    ...
    public void buildOtherPartiesTab(ConfigBuilder<CaseData, State, UserRole> configBuilder) {
        configBuilder.tab("otherParties", "Other Parties")
            ...
            .field("adopAgencyOrLAAdopAgencyOrLaName")
            .field("adopAgencyOrLAAdopAgencyOrLaContactName")
            .field("adopAgencyOrLAAdopAgencyAddressLine1")
            .field("adopAgencyOrLAAdopAgencyTown")
            .field("adopAgencyOrLAAdopAgencyPostcode")
            .field("adopAgencyOrLAAdopAgencyOrLaPhoneNumber")
            .field("adopAgencyOrLAAdopAgencyOrLaContactEmail")
            .label("labelSummary-childLA", null, "### Child’s Local Authority")
            .field("childLocalAuthorityName")
            .field("childSocialWorkerContact")
            ...
            .field("applicantLocalAuthorityName")
            .field("applicantSocialWorkerContact")
