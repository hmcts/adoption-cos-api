...
import static uk.gov.hmcts.reform.adoption.document.DocumentConstants.DOCUMENT_DELETE_URI;
import static uk.gov.hmcts.reform.adoption.document.DocumentConstants.DOCUMENT_DOWNLOAD_URI;
import static uk.gov.hmcts.reform.adoption.document.DocumentConstants.PERMANENT;
import static uk.gov.hmcts.reform.adoption.document.DocumentConstants.USER_ID;
import static uk.gov.hmcts.reform.adoption.document.DocumentConstants.USER_ROLES;
