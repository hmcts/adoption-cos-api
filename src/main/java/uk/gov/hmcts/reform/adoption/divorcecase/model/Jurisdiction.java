...
import uk.gov.hmcts.reform.adoption.divorcecase.model.access.DefaultAccess;
...
import static uk.gov.hmcts.reform.adoption.divorcecase.model.JurisdictionConnections.APP_1_DOMICILED;
import static uk.gov.hmcts.reform.adoption.divorcecase.model.JurisdictionConnections.APP_1_RESIDENT_JOINT;
...
import static uk.gov.hmcts.reform.adoption.divorcecase.model.JurisdictionConnections.APP_2_DOMICILED;
import static uk.gov.hmcts.reform.adoption.divorcecase.model.JurisdictionConnections.APP_2_RESIDENT;
import static uk.gov.hmcts.reform.adoption.divorcecase.model.JurisdictionConnections.RESIDUAL_JURISDICTION;
import static uk.gov.hmcts.reform.adoption.divorcecase.validation.ValidationUtil.CANNOT_EXIST;
import static uk.gov.hmcts.reform.adoption.divorcecase.validation.ValidationUtil.CONNECTION;
