package uk.gov.hmcts.reform.adoption.divorcecase.validation;
...
import static uk.gov.hmcts.reform.adoption.divorcecase.validation.ValidationUtil.flattenLists;
import static uk.gov.hmcts.reform.adoption.divorcecase.validation.ValidationUtil.validateApplicant2BasicCase;
import static uk.gov.hmcts.reform.adoption.divorcecase.validation.ValidationUtil.validateBasicCase;
import static uk.gov.hmcts.reform.adoption.divorcecase.validation.ValidationUtil.validateCaseFieldsForIssueApplication;
