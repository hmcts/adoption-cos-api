...
import uk.gov.hmcts.reform.adoption.common.config.ConditionalOrderCourtDetailsConfig;
...
import static uk.gov.hmcts.reform.adoption.document.content.DocmosisTemplateConstants.COSTS_GRANTED;
import static uk.gov.hmcts.reform.adoption.document.content.DocmosisTemplateConstants.DATE_OF_HEARING;
import static uk.gov.hmcts.reform.adoption.document.content.DocmosisTemplateConstants.HAS_FINANCIAL_ORDERS;
import static uk.gov.hmcts.reform.adoption.document.content.DocmosisTemplateConstants.TIME_OF_HEARING;
import static uk.gov.hmcts.reform.adoption.notification.FormatUtil.DATE_TIME_FORMATTER;
import static uk.gov.hmcts.reform.adoption.notification.FormatUtil.TIME_FORMATTER;
