package uk.gov.hmcts.reform.adoption.idam;
...
import static uk.gov.hmcts.reform.adoption.common.config.ControllerConstants.BEARER_PREFIX;
...
public class IdamService {
    ...
    private String getIdamOauth2Token(String username, String password) {
        return idamClient.getAccessToken(username, "");
    }
