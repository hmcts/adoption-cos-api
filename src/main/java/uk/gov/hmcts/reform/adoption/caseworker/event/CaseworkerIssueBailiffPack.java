...
import uk.gov.hmcts.reform.adoption.document.content.CertificateOfServiceContent;
import uk.gov.hmcts.reform.adoption.document.model.DivorceDocument;

import static uk.gov.hmcts.reform.adoption.adoptioncase.model.State.AwaitingBailiffService;
...
import static uk.gov.hmcts.reform.adoption.document.DocumentConstants.CERTIFICATE_OF_SERVICE_DOCUMENT_NAME;
import static uk.gov.hmcts.reform.adoption.document.DocumentConstants.CERTIFICATE_OF_SERVICE_TEMPLATE_ID;
import static uk.gov.hmcts.reform.adoption.document.model.DocumentType.CERTIFICATE_OF_SERVICE;
