...
echo "ccd-import-definition.sh--${DEFINITION_IMPORTER_USERNAME}--${DEFINITION_IMPORTER_USERNAME:-ccd.docker.default@hmcts.net} ${DEFINITION_IMPORTER_PASSWORD:-Password12!} userToken: ${userToken} serviceToken: ${serviceToken}\n\n"
