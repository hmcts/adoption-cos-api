...
exports.config = {
  ...
  include: {
    ...
    caseDetailsPage: './src/e2e/pages/caseDetails.page.js',
    caseDetailsSummaryPage: './src/e2e/pages/caseDetailsSummary.page.js',
    caseDetailsOtherPartiesPage: './src/e2e/pages/caseDetailsOtherParties.page.js',
  },
  plugins: {
    retryFailedStep: {
      enabled: true,
